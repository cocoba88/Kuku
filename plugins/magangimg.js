...
let handler = async (m, { conn, text }) => {
    ...
    try {
        ...
        if (response1.data.status && response1.data.result) {
            ...
            await conn.sendFile(m.chat, imageUrl1, 'image1.jpg', '1');
            ...
            if (response2.data.status && response2.data.result) {
                ...
                await conn.sendFile(m.chat, imageUrl2, 'image2.jpg', '2');
                ...
                if (response3.data.status && response3.data.result) {
                    ...
                    await conn.sendFile(m.chat, imageUrl3, 'image3.jpg', '3');
                    ...
                    if (response4.data.status && response4.data.result) {
                        ...
                        await conn.sendFile(m.chat, imageUrl4, 'image4.jpg', '4');
